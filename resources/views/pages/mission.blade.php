...
@section('content')
    ...
    <!-- Page Header -->
    <section class="page-header py-5 text-white" style="background: linear-gradient(rgba(0, 51, 102, 0.8), rgba(0, 51, 102, 0.8)), url('https://images.unsplash.com/photo-1497633762265-9d179a990aa6?ixlib=rb-1.2.1&auto=format&fit=crop&w=1350&q=80'); background-size: cover; background-position: center; border-bottom: 5px solid #ffd700;">
                    ...
                    <div class="row g-0">
                        ...
                        <div class="col-lg-3 bg-light p-4 d-flex flex-column align-items-center text-center border-end">
                            <div class="icon-box bg-white text-primary rounded-circle d-inline-flex align-items-center justify-content-center mb-4 shadow-sm" style="width: 100px; height: 100px; border: 2px solid var(--primary-blue);">
                                <i class="bi bi-bullseye fs-1" style="color: var(--primary-blue) !important;"></i>
                            </div>
                            <h4 class="fw-bold text-dark mb-2 text-uppercase small tracking-widest">MISSION</h4>
                        ...
                        <div class="col-lg-9 p-5">
                            <div class="content-header mb-4 pb-3 border-bottom text-center text-lg-start">
                                <h2 class="fw-bold text-dark mb-0" style="color: var(--primary-blue) !important;">The Fransalian Mission</h2>
                            </div>
                                ...
                                <div class="row mt-5 g-4">
                                    <div class="col-md-6 animate__animated animate__fadeInUp">
                                        <div class="d-flex align-items-start">
                                            ...
                                            <div>
                                                <h5 class="fw-bold text-dark">Mental Growth</h5>
                                                <p class="text-muted">Developing critical thinking and academic excellence through rigorous study and inquiry.</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6 animate__animated animate__fadeInUp animate__delay-1s">
                                        <div class="d-flex align-items-start">
                                            <i class="bi bi-check-circle-fill text-success fs-4 me-3"></i>
                                            <div>
                                                <h5 class="fw-bold text-dark">Emotional Maturity</h5>
                                                <p class="text-muted">Nurturing self-awareness, empathy, and strong moral character in a supportive environment.</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
