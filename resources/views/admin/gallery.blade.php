    ...
    <div class="col-12">
        <div class="admin-card p-4">
            ...
            <form method="POST" action="{{ route('admin.gallery.store') }}" enctype="multipart/form-data">
                @csrf
                <div class="row g-3">
                    <div class="col-md-3"><input type="text" name="title" class="form-control" placeholder="Image Title" required></div>
                    <div class="col-md-3">
                        <input type="file" name="image" class="form-control" accept="image/*" required onchange="previewAddImage(this)">
                    </div>
                    ...
                    <div class="col-md-3">
                        <button type="submit" class="btn btn-primary fw-bold"><i class="bi bi-cloud-upload me-1"></i>Upload Image</button>
                    </div>
                    <div class="col-12">
                        <textarea name="description" class="form-control" rows="2" placeholder="Description..."></textarea>
                    </div>
                    <div class="col-12">
                        <img id="addPreview" src="" class="rounded-3 shadow-sm d-none" style="max-height: 180px; object-fit: cover;">
                    </div>
                </div>
            </form>
            <script>
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6">
                        <div class="card border-0 rounded-4 shadow-sm overflow-hidden" style="transition: transform 0.2s;" onmouseover="this.style.transform='translateY(-4px)'" onmouseout="this.style.transform='translateY(0)'">
                            <div style="height: 160px; background: #f0f0f0; overflow: hidden;">
                                <img src="{{ asset('storage/' . $img->image) }}" alt="{{ $img->title }}" class="w-100 h-100" style="object-fit: cover;" onerror="this.src='https://via.placeholder.com/300x160?text=No+Image'">
                            </div>
                ...
                <div class="modal-body">
                    <div class="row g-3">
                        ...
                        <div class="col-12">
                            ...
                            <img id="editPreview{{ $img->id }}" src="{{ asset('storage/' . $img->image) }}" class="rounded-3 shadow-sm mt-2" style="max-height: 120px; object-fit: cover;">
                        </div>
